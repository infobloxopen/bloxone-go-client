...
func main() {
	body := *infra_mgmt.NewInfraAssignTagsRequest() // InfraAssignTagsRequest | 
...
func main() {
	body := *infra_mgmt.NewInfraHost("DisplayName_example") // InfraHost | 
...
func main() {
	id := "id_example" // string | An application specific resource identity of a resource
	body := *infra_mgmt.NewInfraDisconnectRequest() // InfraDisconnectRequest | 
...
func main() {
	...
	body := *infra_mgmt.NewInfraReplaceHostRequest() // InfraReplaceHostRequest | 
...
func main() {
	body := *infra_mgmt.NewInfraUnassignTagsRequest() // InfraUnassignTagsRequest | 
