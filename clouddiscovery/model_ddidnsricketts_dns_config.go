...
// checks if the DdidnsrickettsDNSConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DdidnsrickettsDNSConfig{}

// DdidnsrickettsDNSConfig struct for DdidnsrickettsDNSConfig
type DdidnsrickettsDNSConfig struct {
...
type _DdidnsrickettsDNSConfig DdidnsrickettsDNSConfig
...
func (o DdidnsrickettsDNSConfig) MarshalJSON() ([]byte, error) {
...
func (o DdidnsrickettsDNSConfig) ToMap() (map[string]interface{}, error) {
...
func (o *DdidnsrickettsDNSConfig) UnmarshalJSON(data []byte) (err error) {
	varDdidnsrickettsDNSConfig := _DdidnsrickettsDNSConfig{}

	err = json.Unmarshal(data, &varDdidnsrickettsDNSConfig)

	if err != nil {
		return err
	}

	*o = DdidnsrickettsDNSConfig(varDdidnsrickettsDNSConfig)
...
type NullableDdidnsrickettsDNSConfig struct {
	value *DdidnsrickettsDNSConfig
	isSet bool
}

func (v NullableDdidnsrickettsDNSConfig) Get() *DdidnsrickettsDNSConfig {
	return v.value
}

func (v *NullableDdidnsrickettsDNSConfig) Set(val *DdidnsrickettsDNSConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableDdidnsrickettsDNSConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableDdidnsrickettsDNSConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDdidnsrickettsDNSConfig(val *DdidnsrickettsDNSConfig) *NullableDdidnsrickettsDNSConfig {
	return &NullableDdidnsrickettsDNSConfig{value: val, isSet: true}
}

func (v NullableDdidnsrickettsDNSConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDdidnsrickettsDNSConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
