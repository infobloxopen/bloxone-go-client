...
------------ | ------------- | ------------- | -------------
**Results** | Pointer to [**[]ContentCategory**](ContentCategory.md) | The list of Content Category objects. | [optional] 

## Methods

### NewContentCategoryMultiResponse
...
### NewContentCategoryMultiResponseWithDefaults
