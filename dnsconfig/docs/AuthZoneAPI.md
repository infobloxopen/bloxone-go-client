...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.AuthZoneAPI.Create(context.Background()).Body(body).Inherit(inherit).Execute()
	if err != nil {
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.AuthZoneAPI.List(context.Background()).Fields(fields).Filter(filter).Offset(offset).Limit(limit).PageToken(pageToken).OrderBy(orderBy).Tfilter(tfilter).TorderBy(torderBy).Inherit(inherit).Execute()
	if err != nil {
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.AuthZoneAPI.Read(context.Background(), id).Fields(fields).Inherit(inherit).Execute()
	if err != nil {
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.AuthZoneAPI.Update(context.Background(), id).Body(body).Inherit(inherit).Execute()
	if err != nil {
