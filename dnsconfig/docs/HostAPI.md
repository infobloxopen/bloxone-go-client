...
func main() {
	...
	resp, r, err := apiClient.HostAPI.List(context.Background()).Fields(fields).Filter(filter).Offset(offset).Limit(limit).PageToken(pageToken).OrderBy(orderBy).Tfilter(tfilter).TorderBy(torderBy).Inherit(inherit).Execute()
	if err != nil {
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.HostAPI.Read(context.Background(), id).Fields(fields).Inherit(inherit).Execute()
	if err != nil {
...
func main() {
	...
	apiClient := dnsconfig.NewAPIClient()
	resp, r, err := apiClient.HostAPI.Update(context.Background(), id).Body(body).Inherit(inherit).Execute()
	if err != nil {
