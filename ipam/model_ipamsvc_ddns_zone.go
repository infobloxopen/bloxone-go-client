...
type _IpamsvcDDNSZone IpamsvcDDNSZone
...
func (o *IpamsvcDDNSZone) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcDDNSZone := _IpamsvcDDNSZone{}

	err = json.Unmarshal(bytes, &varIpamsvcDDNSZone)

	if err != nil {
		return err
	}

	*o = IpamsvcDDNSZone(varIpamsvcDDNSZone)
