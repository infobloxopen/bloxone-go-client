...
func (o *IpamsvcName) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcName := _IpamsvcName{}

	err = json.Unmarshal(bytes, &varIpamsvcName)

	if err != nil {
		return err
	}

	*o = IpamsvcName(varIpamsvcName)
