...
type _IpamsvcCopySubnet IpamsvcCopySubnet
...
func (o *IpamsvcCopySubnet) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcCopySubnet := _IpamsvcCopySubnet{}

	err = json.Unmarshal(bytes, &varIpamsvcCopySubnet)

	if err != nil {
		return err
	}

	*o = IpamsvcCopySubnet(varIpamsvcCopySubnet)
