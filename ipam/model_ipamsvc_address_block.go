...
func (o *IpamsvcAddressBlock) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *IpamsvcAddressBlock) SetDdnsSendUpdatesNil() {
...
func (o *IpamsvcAddressBlock) SetDdnsUseConflictResolutionNil() {
...
func (o *IpamsvcAddressBlock) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
