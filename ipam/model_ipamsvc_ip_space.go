...
type IpamsvcIPSpace struct {
	...
	InheritanceAssignedHosts        map[string]interface{} `json:"inheritance_assigned_hosts,omitempty"`
}
...
func (o *IpamsvcIPSpace) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *IpamsvcIPSpace) SetDdnsSendUpdatesNil() {
...
func (o *IpamsvcIPSpace) SetDdnsUseConflictResolutionNil() {
...
func (o *IpamsvcIPSpace) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
// SetInheritanceAssignedHosts gets a reference to the given map[string]interface{} and assigns it to the InheritanceAssignedHosts field.
