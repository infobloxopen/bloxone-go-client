...
type _IpamsvcFixedAddress IpamsvcFixedAddress
...
func (o *IpamsvcFixedAddress) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcFixedAddress := _IpamsvcFixedAddress{}

	err = json.Unmarshal(bytes, &varIpamsvcFixedAddress)

	if err != nil {
		return err
	}

	*o = IpamsvcFixedAddress(varIpamsvcFixedAddress)
