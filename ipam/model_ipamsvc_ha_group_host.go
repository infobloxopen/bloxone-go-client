...
type _IpamsvcHAGroupHost IpamsvcHAGroupHost
...
func (o *IpamsvcHAGroupHost) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcHAGroupHost := _IpamsvcHAGroupHost{}

	err = json.Unmarshal(bytes, &varIpamsvcHAGroupHost)

	if err != nil {
		return err
	}

	*o = IpamsvcHAGroupHost(varIpamsvcHAGroupHost)
