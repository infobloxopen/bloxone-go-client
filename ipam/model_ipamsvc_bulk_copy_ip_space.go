...
func (o *IpamsvcBulkCopyIPSpace) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIpamsvcBulkCopyIPSpace := _IpamsvcBulkCopyIPSpace{}

	err = json.Unmarshal(bytes, &varIpamsvcBulkCopyIPSpace)

	if err != nil {
		return err
	}

	*o = IpamsvcBulkCopyIPSpace(varIpamsvcBulkCopyIPSpace)
