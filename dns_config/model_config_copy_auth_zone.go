...
type _ConfigCopyAuthZone ConfigCopyAuthZone
...
func (o *ConfigCopyAuthZone) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConfigCopyAuthZone := _ConfigCopyAuthZone{}

	err = json.Unmarshal(bytes, &varConfigCopyAuthZone)

	if err != nil {
		return err
	}

	*o = ConfigCopyAuthZone(varConfigCopyAuthZone)
