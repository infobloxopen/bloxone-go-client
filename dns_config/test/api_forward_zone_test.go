...
var ConfigCopyForwardZone_Post = openapiclient.ConfigCopyForwardZone{
...
var ConfigForwardZone_Post = openapiclient.ConfigForwardZone{
...
var ConfigForwardZone_Patch = openapiclient.ConfigForwardZone{
...
func Test_dns_config_ForwardZoneAPIService(t *testing.T) {
	...
	t.Run("Test ForwardZoneAPIService ForwardZoneCopy", func(t *testing.T) {
		...
		configuration.HTTPClient = internal.NewTestClient(func(req *http.Request) *http.Response {
			...
			require.Equal(t, ConfigCopyForwardZone_Post, reqBody)
		...
		resp, httpRes, err := apiClient.ForwardZoneAPI.ForwardZoneCopy(context.Background()).Body(ConfigCopyForwardZone_Post).Execute()
		require.Nil(t, err)
	...
	t.Run("Test ForwardZoneAPIService ForwardZoneCreate", func(t *testing.T) {
		...
		configuration.HTTPClient = internal.NewTestClient(func(req *http.Request) *http.Response {
			...
			require.NoError(t, json.NewDecoder(req.Body).Decode(&reqBody))
			require.Equal(t, ConfigForwardZone_Post, reqBody)
		...
		apiClient := openapiclient.NewAPIClient(configuration)
		resp, httpRes, err := apiClient.ForwardZoneAPI.ForwardZoneCreate(context.Background()).Body(ConfigForwardZone_Post).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		require.Equal(t, http.StatusOK, httpRes.StatusCode)
	})
	...
	t.Run("Test ForwardZoneAPIService ForwardZoneRead", func(t *testing.T) {
		...
		configuration.HTTPClient = internal.NewTestClient(func(req *http.Request) *http.Response {
			require.Equal(t, http.MethodGet, req.Method)
			require.Equal(t, "/api/ddi/v1/dns/forward_zone/"+*ConfigForwardZone_Post.Id, req.URL.Path)
			require.Equal(t, "application/json", req.Header.Get("Accept"))
		...
		apiClient := openapiclient.NewAPIClient(configuration)
		resp, httpRes, err := apiClient.ForwardZoneAPI.ForwardZoneRead(context.Background(), *ConfigForwardZone_Post.Id).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		require.Equal(t, http.StatusOK, httpRes.StatusCode)
	})
	...
	t.Run("Test ForwardZoneAPIService ForwardZoneUpdate", func(t *testing.T) {
		...
		configuration.HTTPClient = internal.NewTestClient(func(req *http.Request) *http.Response {
			...
			require.Equal(t, "/api/ddi/v1/dns/forward_zone/"+*ConfigForwardZone_Patch.Id, req.URL.Path)
			require.Equal(t, "application/json", req.Header.Get("Accept"))

			var reqBody openapiclient.ConfigForwardZone
			require.NoError(t, json.NewDecoder(req.Body).Decode(&reqBody))
			require.Equal(t, ConfigForwardZone_Patch, reqBody)
		...
		apiClient := openapiclient.NewAPIClient(configuration)
		resp, httpRes, err := apiClient.ForwardZoneAPI.ForwardZoneUpdate(context.Background(), *ConfigForwardZone_Patch.Id).Body(ConfigForwardZone_Patch).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		require.Equal(t, http.StatusOK, httpRes.StatusCode)
	})
	...
	t.Run("Test ForwardZoneAPIService ForwardZoneDelete", func(t *testing.T) {
		...
		apiClient := openapiclient.NewAPIClient(configuration)
		httpRes, err := apiClient.ForwardZoneAPI.ForwardZoneDelete(context.Background(), *ConfigForwardZone_Post.Id).Execute()
		require.Nil(t, err)
		require.Equal(t, http.StatusOK, httpRes.StatusCode)
	})
