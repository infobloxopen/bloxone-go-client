...
type _ConfigForwardNSG ConfigForwardNSG
...
func (o *ConfigForwardNSG) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConfigForwardNSG := _ConfigForwardNSG{}

	err = json.Unmarshal(bytes, &varConfigForwardNSG)

	if err != nil {
		return err
	}

	*o = ConfigForwardNSG(varConfigForwardNSG)
