...
type _ConfigRootNS ConfigRootNS
...
func (o *ConfigRootNS) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConfigRootNS := _ConfigRootNS{}

	err = json.Unmarshal(bytes, &varConfigRootNS)

	if err != nil {
		return err
	}

	*o = ConfigRootNS(varConfigRootNS)
