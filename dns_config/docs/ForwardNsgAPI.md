...
func main() {
    body := *openapiclient.NewConfigForwardNSG("Name_example") // ConfigForwardNSG | 
...
Other parameters are passed through a pointer to a apiForwardNsgListRequest struct via the builder pattern
