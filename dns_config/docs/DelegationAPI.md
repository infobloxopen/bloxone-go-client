...
func main() {
	body := *dns_config.NewConfigDelegation() // ConfigDelegation | 
...
Other parameters are passed through a pointer to a apiDelegationListRequest struct via the builder pattern
